...
begin
  ...
  exec ENV["HOMEBREW_BREW_FILE"], *args.argv
end

begin
  trap("INT", std_trap) # restore default CTRL-C handler

  empty_argv = args.argv.empty?
  help_flag_list = %w[-h --help --usage -?]
  help_flag = !ENV["HOMEBREW_HELP"].nil?
  cmd = nil

  args.argv.dup.each_with_index do |arg, i|
  ...
  if cmd
    ...
    unless internal_cmd
      ...
      if internal_dev_cmd && !args.homebrew_developer?
  ...
  if internal_cmd
    ...
    exec HOMEBREW_BREW_FILE, cmd, *args.argv
  end
rescue UsageError => e
  require "help"
